...
public class HalsteadDifficultyCheck extends AbstractCheck {
    ...
    public int[] getDefaultTokens() {
    	...
    	//https://checkstyle.sourceforge.io/apidocs/com/puppycrawl/tools/checkstyle/checks/whitespace/
    	//OperatorWrapCheck.html
    	Collection<Integer> tokenTypesCollection = Arrays.asList(TokenTypes.PLUS,TokenTypes.MINUS,TokenTypes.STAR,TokenTypes.DIV,TokenTypes.MOD,
    ...
    public void finishTree(DetailAST ast) {
    	if(operandTotal == 0)
    	{
    		...
    		int sum = ((operatorSet.size()/2) * operandTotal)/operandSet.size();
