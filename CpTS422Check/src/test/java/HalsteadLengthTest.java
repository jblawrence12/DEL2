...
import HalsteadPackage.HalsteadLengthCheck;
...
public class HalsteadLengthTest {
	 ...
	 HalsteadLengthCheck  halsteadLength = new  HalsteadLengthCheck();
    ...
    public void testGetDefaultTokens() 
    {
        ...
        assertArrayEquals(expectedTokens, halsteadLength.getRequiredTokens());
    }
  ...
  //Test that visit is covered
    ...
    {
    	HalsteadLengthCheck spyHalsteadLength = spy(new HalsteadLengthCheck());
        DetailAST mockAST = mock(DetailAST.class);
        spyHalsteadLength.visitToken(mockAST);
        verify(spyHalsteadLength).visitToken(mockAST);
    }
    ...
    public void testBeginTree() 
    {
    	HalsteadLengthCheck  spyHalsteadLength= spy(new HalsteadLengthCheck());
        DetailAST mockAST = mock(DetailAST.class);
        spyHalsteadLength.beginTree(mockAST);
        verify(spyHalsteadLength).beginTree(mockAST);
    }
    ...
    public void testFinishTree() {
    	HalsteadLengthCheck  spyHalsteadLength= spy(new HalsteadLengthCheck());
        DetailAST mockAST = mock(DetailAST.class);
        doNothing().when(spyHalsteadLength).log(anyInt(), anyString());
        when(mockAST.getLineNo()).thenReturn(1);
        spyHalsteadLength.finishTree(mockAST);
        verify(spyHalsteadLength, times(1)).log(eq(1), contains("Halstead Length: 0JL"));
    }
    ...
    public void testGetAcceptableTokens() 
    {
        ...
        int[] expectedTokens = {TokenTypes.PLUS,TokenTypes.MINUS,TokenTypes.STAR,TokenTypes.DIV,TokenTypes.MOD,
        		...
        		TokenTypes.ENUM_CONSTANT_DEF,TokenTypes.CHAR_LITERAL,TokenTypes.LITERAL_BOOLEAN,TokenTypes.LITERAL_CHAR,
        		TokenTypes.METHOD_CALL,TokenTypes.METHOD_DEF,TokenTypes.METHOD_REF,TokenTypes.LITERAL_TRUE,TokenTypes.LITERAL_FALSE,TokenTypes.LITERAL_NULL};
        assertArrayEquals(expectedTokens, halsteadLength.getAcceptableTokens());
    }
